...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const role        = interaction.guild.roles.cache.get("976384794923503657");
        ...
        if (target.roles.cache.has(role.id)){
            ...
            target.setNickname("RC | " + nameOfTarget.substring(4, nameOfTarget.length));
            ...
            embed.setDescription(`RB Cadet welcome message is posted in ${channelProspects}.\n${role} added to ${target}.\n${oldRole} role removed from ${target}.\nGave ${target} fancy RC tags.`);
        }
